...
# python -m pytest -v --driver Chrome --driver-path C:\chromedriver\chromedriver.exe tests/test_auth_positive.py
...
def test_auth_user_phone(driver):
    ...
    enter_phone.send_keys('+7 963 775-51-75')
    time.sleep(4)
...
def test_auth_user_login(driver):
    ...
    enter_login.send_keys('rtkid_1724491242188')
    time.sleep(4)
...
def test_forgotten_password_nomber(driver):
    ...
    enter_nomber.send_keys('+7 963 775-51-75')
    time.sleep(20)
