...
# python -m pytest -v --driver Chrome --driver-path C:\chromedriver\chromedriver.exe tests/test_reg_negative.py
...
#     # Вводим email
#     enter_email.send_keys('paseg@mail.ru')
#     time.sleep(4)
#
...
#     enter_first_name.send_keys('Anna')
#     time.sleep(5)
#
#     enter_last_name = driver.find_element(By.XPATH, '//*[@id="page-right"]/div/div[1]/div/form/div[1]/div[2]/div/input')
#     # Ввод фамилии
...
#     enter_email = driver.find_element(By.XPATH, '//*[@id="address"]')
#     # Вводим email
#     enter_email.send_keys('pireoida@mail.ru')
#     time.sleep(4)
#
#     enter_password = driver.find_element(By.XPATH, '//*[@id="password"]')
#     # Вводим пароль
...
#     enter_first_name.send_keys('14478322')
#     time.sleep(5)
#
#     enter_last_name = driver.find_element(By.XPATH, '//*[@id="page-right"]/div/div[1]/div/form/div[1]/div[2]/div/input')
#     # Ввод фамилии
...
#     enter_email = driver.find_element(By.XPATH, '//*[@id="address"]')
#     # Вводим email
#     enter_email.send_keys('lieoiruwQ@mail.ru')
#     time.sleep(4)
#
#     enter_password = driver.find_element(By.XPATH, '//*[@id="password"]')
#     # Вводим пароль
...
#     enter_first_name.send_keys('Anна')
#     time.sleep(5)
#
#     enter_last_name = driver.find_element(By.XPATH, '//*[@id="page-right"]/div/div[1]/div/form/div[1]/div[2]/div/input')
#     # Ввод фамилии
...
#     enter_email = driver.find_element(By.XPATH, '//*[@id="address"]')
#     # Вводим email
#     enter_email.send_keys('mmeeieSA@mail.ru')
#     time.sleep(4)
#
#     enter_password = driver.find_element(By.XPATH, '//*[@id="password"]')
#     # Вводим пароль
...
#     enter_email = driver.find_element(By.XPATH, '//*[@id="address"]')
#     # Вводим email
#     enter_email.send_keys('maeeie@mail.ru')
#     time.sleep(4)
#
#     enter_password = driver.find_element(By.XPATH, '//*[@id="password"]')
#     # Вводим пароль
...
#     enter_first_name.send_keys('АннаАннаАннаАннаАннаАннаАннаАнна')
#     time.sleep(5)
#
#     enter_last_name = driver.find_element(By.XPATH, '//*[@id="page-right"]/div/div[1]/div/form/div[1]/div[2]/div/input')
#     # Ввод фамилии
...
#     enter_email = driver.find_element(By.XPATH, '//*[@id="address"]')
#     # Вводим email
#     enter_email.send_keys('myygdyq@mail.ru')
#     time.sleep(4)
#
#     enter_password = driver.find_element(By.XPATH, '//*[@id="password"]')
#     # Вводим пароль
...
#     enter_email = driver.find_element(By.XPATH, '//*[@id="address"]')
#     # Вводим email
#     enter_email.send_keys('miweho@mail.ru')
#     time.sleep(4)
#
#     enter_password = driver.find_element(By.XPATH, '//*[@id="password"]')
#     # Вводим пароль
...
#     enter_email = driver.find_element(By.XPATH, '//*[@id="address"]')
#     # Вводим email
#     enter_email.send_keys('peariua@mail.ru')
#     time.sleep(4)
#
#     enter_password = driver.find_element(By.XPATH, '//*[@id="password"]')
#     # Вводим пароль
...
# #
# # ТЕСТ № 9
# def test_reg_Latin_letters_last_name(driver):
#     ''' Латинские буквы в строке ввода "Фамилия" '''
#
#     # Нажимаем на кнопку "Зарегистроваться"
#     driver.find_element(By.ID, "kc-register").click()
#     time.sleep(5)
...
#     enter_last_name = driver.find_element(By.XPATH, '//*[@id="page-right"]/div/div[1]/div/form/div[1]/div[2]/div/input')
#
#     # Латинские буквы в поле ввода "Фамилия"
#     enter_last_name.send_keys('Zaitsava')
#     time.sleep(5)
#
#     # Выбор региона
#     wait = WDW(driver, 5)
...
#     enter_email = driver.find_element(By.XPATH, '//*[@id="address"]')
#     # Вводим email
#     enter_email.send_keys('pearji@mail.ru')
#     time.sleep(4)
#
#     enter_password = driver.find_element(By.XPATH, '//*[@id="password"]')
#     # Вводим пароль
...
def test_reg_numbers_string_last_name(driver):
    ...
    enter_last_name.send_keys('14478322')
    time.sleep(5)
    ...
    enter_email = driver.find_element(By.XPATH, '//*[@id="address"]')
    # Вводим email
    enter_email.send_keys('pjai@mail.ru')
    time.sleep(4)
...
def test_reg_Latin_Cyrillic_last_name(driver):
    ...
    enter_last_name.send_keys('Zaitцева')
    time.sleep(5)
    ...
    enter_email = driver.find_element(By.XPATH, '//*[@id="address"]')
    # Вводим email
    enter_email.send_keys('pearui@mail.ru')
    time.sleep(4)
...
def test_reg_one_character_last_name(driver):
    ...
    enter_email = driver.find_element(By.XPATH, '//*[@id="address"]')
    # Вводим email
    enter_email.send_keys('mрррf@mail.ru')
    time.sleep(4)
...
def test_reg_exceeding_number_characters_last_name(driver):
    ...
    enter_last_name.send_keys('ЗайцеваЗайцеваЗайцеваЗайцеваЗай')
    time.sleep(5)
    ...
    enter_email = driver.find_element(By.XPATH, '//*[@id="address"]')
    # Вводим email
    enter_email.send_keys('yyiuyryq@mail.ru')
    time.sleep(4)
...
def test_reg_forbidden_spec_characterss_last_name(driver):
    ...
    enter_email = driver.find_element(By.XPATH, '//*[@id="address"]')
    # Вводим email
    enter_email.send_keys('myyuytf@mail.ru')
    time.sleep(4)
